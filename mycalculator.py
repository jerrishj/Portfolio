...
# Adds a number or operator to the current calculation
...
# Clears the entire calculation and resets the display
def clear_field():
    global calculation
    calculation = ""
    text_result.delete(1.0, "end")
...
btn_back = tk.Button(root, text="⌫", command=backspace, width=5, font=("Arial", 14))
